        ...
        client.on('messageReactionAdd', async (reaction, user) => {
            ...
            if(reaction.emoji.name === '⛔') {
                ...
                if(!reaction.message.guild.members.cache.get(user.id).hasPermission('MANAGE_CHANNELS')) return // If User Who Reacted Doesn't Have MANAGE_CHANNELS Permission
                    ...
                    setTimeout(() => reaction.message.channel.delete(), 5000) // Delete Channel In 5 Seconds
                ...
                if(!reaction.message.guild.members.cache.get(user.id).hasPermission('MANAGE_CHANNELS')) return // If User Who Reacted Doesn't Have MANAGE_CHANNELS Permission
                    ...
                    const memberinticket = db.fetch(`ticket-user_${reaction.message.channel.id}`) // Get User In ticket
